        ...
        <div className="max-w-4xl mx-auto space-y-16">
          <div className="text-center space-y-4">
            ...
            <p className="text-lg text-neutral-600">
              The Botswana Communications Regulatory Authority is led by a team of non-executive board directors who provide strategic direction in line with the National Digital Economy Roadmap.
            </p>
          </div>
          ...
          <div className="space-y-12">
            {boardOfDirectors.map((member, idx) => (
              <div key={idx} className="bg-white p-8 md:p-10 rounded-[2rem] shadow-sm border border-neutral-100 flex flex-col md:flex-row gap-8 items-start">
                <div className="w-24 h-24 md:w-32 md:h-32 rounded-full overflow-hidden bg-blue-50 border-4 border-blue-100 shrink-0 flex items-center justify-center">
                  <span className="text-3xl md:text-5xl font-bold text-blue-200 uppercase">
